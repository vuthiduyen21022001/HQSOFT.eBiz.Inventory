...
namespace HQSOFT.eBiz.Inventory.Data;

public class InventoryTenantDatabaseMigrationHandler :
    ...
    ITransientDependency
{
    ...
    private readonly ILogger<InventoryTenantDatabaseMigrationHandler> _logger;

    public InventoryTenantDatabaseMigrationHandler(
        IDbContextProvider<AuthServerHostMigrationsDbContext> dbContextProvider,
        ICurrentTenant currentTenant,
        IUnitOfWorkManager unitOfWorkManager,
        IDataSeeder dataSeeder,
        ITenantStore tenantStore,
        ILogger<InventoryTenantDatabaseMigrationHandler> logger)
    {
